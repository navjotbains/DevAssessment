...
namespace TodoList.Api.Controllers
{
    ...
    public class TodoItemsController : ControllerBase
    {
        ...
        {
            var results = await _context.TodoItems.ToListAsync();//removed where clause intentionally to show the completed todos -- Where(x => !x.IsCompleted)
            return Ok(results);
        }
        ...
        public async Task<IActionResult> PutTodoItem(Guid id, TodoItem todoItem)
        {
            ...
            return AcceptedAtAction(nameof(GetTodoItem), new { id = todoItem.Id }, todoItem);
        }
